...
const Kanban: React.FC = () => {
  ...
  const handleDragEnd = (result: DropResult) => {
    ...
    if (source.droppableId !== destination.droppableId) {
      ...
      movedTask.updatedAt = moment().toISOString(); // Update timestamp
    }
          ...
          {tasks.map((task, index) => {
            ...
            const actionContent = (
              <Space direction="vertical">
                <Button onClick={() => router.push(`/list/${task.key}`)}>
                  <EyeOutlined />
                </Button>
                <Button onClick={() => router.push(`/list/${task.key}/edit`)}>
                  <EditOutlined />
                </Button>
                <Button
                  danger
                ...
                {(provided, snapshot) => (
                  ...
                  >
                    <div className="flex justify-between items-start gap-2">
                      ...
                      <div className="flex flex-col justify-between items-end min-h-20">
                        <Tag
                          color={
                            task.priority === "LOW"
                              ? "green"
  ...
  }, [deadlineFilter, priorityFilter, searchText]);
